      ...
      <section className="py-12 px-4 pb-32">
        <div className="max-w-6xl mx-auto">
          <div className="grid gap-12 md:gap-16">
            {portfolioItems.map((item, index) => <motion.div key={item.id} initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
                ...
                <Card className="overflow-hidden bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/30 transition-all duration-300">
                  <div className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-6 lg:gap-8`}>
                    ...
                    <div className="lg:w-1/2 p-6 lg:p-8 flex flex-col justify-center">
                      ...
                      <a href={item.url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-primary hover:text-primary/80 font-medium transition-colors group">
                        צפייה בפרויקט
